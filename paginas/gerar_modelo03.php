		...
		<div id="main" class="container">
			...
			<form>
				...
				<div id="parte01" class="fundo">
					...
					<textarea id="field" onkeyup="countCharTema(this)" wrap="hard" rows="1" cols="35" maxlength="34"
						name="title_text" /></textarea>


					<h5>Descrição <span id="charNumDescricao">/ 140 caracteres</span></h5>
					<textarea onkeyup="countCharDescricao(this)" wrap="hard" rows="3" cols="50" maxlength="155"
