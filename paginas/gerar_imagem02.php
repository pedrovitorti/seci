...
/*
	...
	<body>
		...
		<!-- Conteúdo principal -->
			...
			<form action="./gerar_image_02/enviar02.php" method="POST" enctype="multipart/form-data">
			...
			<h4>Passo 02 - Configurar Imagem</h4>
					...
					<p>Título:<br /><textarea wrap="hard" rows="2" cols="31" maxlength="62" name="title_text" /></textarea></p>
					<p>Descrição:<br /><textarea wrap="hard" rows="1" cols="50" maxlength="47"name="description_text" /></textarea></p>
